import os
import configparser
import omegafaceTest.getpathInfo  # 引入我们自己的写的获取路径的类

path = omegafaceTest.getpathInfo.get_Path()  # 调用实例化，还记得这个类返回的路径为C:\Users\songlihui\PycharmProjects\dkxinterfaceTest
